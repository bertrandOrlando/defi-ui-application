      ...
      <div className="px-4">
        <div className="flex flex-col gap-1">
          ...
          <div className="flex justify-between items-center mt-1">
            <h1 className="text-2xl font-semibold">Alarms Details <span style={{ color: "limegreen" }}>●</span> </h1>
              ...
              <Table>
                ...
                <TableBody>
                  {filteredAlarms.map((alarm, index) => (
                    ...
                    >
                      <TableCell sx={{ color: "#fff", py: 1.5 }}>{alarm.id}</TableCell>
                  ...
                  {filteredAlarms.length === 0 && (
                    <TableRow>
                      <TableCell colSpan={9} align="center" sx={{ color: "#fff", py: 3 }}>
                        No alarms found
                      </TableCell>
                    </TableRow>
                  )}
