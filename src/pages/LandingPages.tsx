...
const LandingPage = () => {
  ...
  const Card = ({
    ...
    return (
      <div
        className="flex flex-col items-center justify-center p-6 bg-[#343536] h-48 rounded-lg shadow-lg hover:shadow-xl cursor-pointer group hover:bg-[#282828] border border-transparent hover:border-blue-500"
        onClick={handleClick}
      >
        <div
      ...
      <main className="container mx-auto p-8">
        ...
        <div className="mb-2">
          ...
          <div className="flex items-center justify-between mb-4 text-sm">
            <p className="text-gray-400 text-sm flex items-center gap-x-1">
              {" "}
              <FaRegCalendarCheck />
              Last sign in: {currentUser?.lastSignIn || "N/A"}
            </p>
            {/* row data section */}
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-6 gap-4">
          <Card
            title="Vendor Agreement & Query"
            color="#3498b3"
            icon={<LuClipboardList />}
            redirectLink="vendor-agreement-query"
          />
          <Card
            title="Vendor Management"
            color="#099487"
            icon={<HiOutlineDocumentMagnifyingGlass />}
            redirectLink="vendor-management"
          />
          <Card
            title="Vendor Communication"
            color="#edb026"
            icon={<HiOutlineChatAlt2 />}
            redirectLink="vendor-communication"
          />
          <Card
            title="Policy Configuration"
            color="#e58029"
            icon={<FaRegFolderOpen />}
            redirectLink="policy-configuration"
          />
          <Card
          ...
          <Card
            ...
            color="#c4515c"
            icon={<LuNetwork />}
            redirectLink="network-planning"
          />
          <Card
            title="Service Assurance"
            description="21 Enterprises in total"
            color="#8a5480"
            icon={<TbWorld />}
            redirectLink="service-assurance"
          />
          <Card
            title="Inventory"
            color="#8a5480"
          ...
          <Card
            ...
            color="#746fa7"
            icon={<BiServer />}
            redirectLink="network-configuration"
          />
          <Card
            title="Service Flow Design"
            color="#7dc161"
            icon={<RiFlowChart />}
            redirectLink="service-flow-design"
          />
          <Card
            title="Reporting & Analytics"
            color="#3498b3"
            icon={<TbFileAnalytics />}
            redirectLink="reporting-analytics"
          />
          <Card
            title="Notifications"
            color="#3498b3"
